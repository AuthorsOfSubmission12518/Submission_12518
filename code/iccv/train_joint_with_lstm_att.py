...
# parser.add_argument('--lmbda', type=float, default=0.05, required=False)
# parser.add_argument('--device', type=str, default='cuda:1', required=False)
# parser.add_argument('--batch_size', default=3, type=int)
# parser.add_argument('--worker_num', default=2, type=int)
# parser.add_argument('--inference', action='store_true')
# parser.add_argument('--recon_detach', default=False, action='store_true')
# parser.add_argument('--com_detach', default=False, action='store_true')
# parser.add_argument('--rdd', action='store_true')
...
if __name__ == '__main__':
    ...
    pms['save_checkpoint'] = '/home/kxfeng/iccv/checkpoint/lic/lstm_att'
    # if args.rdd:
    #     pms['save_checkpoint'] = '/home/kxfeng/iccv/checkpoint/rdd/lstm_att'
    # elif args.recon_detach:
    #     pms['save_checkpoint'] = '/home/kxfeng/iccv/checkpoint/recon_detach'
    # pms['lmbda'] = 0.05
    # pms['device'] = 'cuda:1'
    # pms['batch'] = 3
    # pms['worker_num'] = 2
