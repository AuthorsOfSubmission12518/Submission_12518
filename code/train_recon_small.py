...
from folder.spk_folder import spk_provider_small
from recon_net.spk2imgnet_small import new_Spike_Net_v3 as recon_net
from pms.train_recon_small_pms import pms
...
def main():
    train_dataset = spk_provider_small(pms['spk_path'], pms['gt_path'], 'train')
    test_dataset = spk_provider_small(pms['spk_path'], pms['gt_path'], 'test')
        ...
        if loss < best_loss:
            ...
            if pms['save']:
                if pms['save_checkpoint']:
                    ...
                    filename = f'/home/kxfeng/iccv/checkpoint/recon_net_small.pth'
