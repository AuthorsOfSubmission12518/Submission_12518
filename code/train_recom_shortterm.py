...
from folder.spk_folder import spk_provider_shortterm
from recon_net.spk2imgnet_shortterm import new_Spike_Net_v3 as recon_net
from recon_net.spk2imgnet import new_Spike_Net_v3 as spk2imgnet
from pms.train_recon_shortterm_pms import pms
...
def main():
    train_dataset = spk_provider_shortterm(pms['spk_path'], pms['gt_path'], 'train')
    test_dataset = spk_provider_shortterm(pms['spk_path'], pms['gt_path'], 'test')
    ...
    pre_net = spk2imgnet(in_channels=13, features=64, out_channels=1, win_r=6, win_step=7)
    pre_net.load_state_dict(torch.load('/home/kxfeng/iccv/checkpoint/recon_net.pth', map_location='cpu')['state_dict'])
    net.extractor = pre_net.extractor
        ...
        if loss < best_loss:
            ...
            if pms['save']:
                if pms['save_checkpoint']:
                    ...
                    filename = f'/home/kxfeng/iccv/checkpoint/recon_net_shortterm.pth'
